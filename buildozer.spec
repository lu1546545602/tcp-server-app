...
# (str) Package name
package.name = tcpserver

# (str) Package domain (needed for android/ios packaging)
package.domain = org.gameserver
...
requirements = python3,kivy==2.0.0,pyjnius,plyer
...
# Pass a custom --color=yes|no|auto argument to p4a
# p4a.color = auto

# (bool) Whether or not to collect models from .kv files
#kivy.collect_models = 0
...
#android.logcat_filter_only = False
...
# (bool) disables the compilation of py to pyc/pyo via python -O or -OO
# android.no-compile-pyo = True

# (str) The format used to package the app for release mode (aab or apk or aar).
# 'aar' can only be used with android.gradle_dependencies.
# 'aab' is the format required for uploading the app to Google Play Store.
# 'apk' is the format required for sideloading the app.
